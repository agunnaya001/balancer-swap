...
export interface BALTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "INITIAL_SUPPLY"
      | "allowance"
...
export interface BALToken extends BaseContract {
  connect(runner?: ContractRunner | null): BALToken;
  waitForDeployment(): Promise<this>;

  interface: BALTokenInterface;
